...
# ----------- abstract methods that concrete subclass must support-----
    ...
    def parent(self):
        ...
        raise NotImplementedError('must be implemented subclass')
    ...
    def __len__(self):
        """Return the total the number of elements in the tree."""
        raise NotImplementedError('must be implemented by subclass')
...
# ------- additional abstract methods----
    def left(self, p):
        """ Return a Position represeting p's left child
            Return None if p does not have a left child"""
        raise NotImplementedError('must be implemented by subclass')

    def right(self, p):
        """ Return a Position represeting p's right child
    ...
    def children(self, p):
        """Generate an interation of Position representing p's children"""
...
class LinkedBinaryTree(BinaryTree):
    ...
    class _Node:
        ...
        def __int__(self, element, parent=None, left=None, right=None):
    ...
    def parent(self, p):
        """Return the Postion of p's parent (or None if p is root)"""
    ...
    def _add_right(self, p, e):
        """Crete a new right child for Position p, storing element e"""
